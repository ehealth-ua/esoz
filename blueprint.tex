...
\begin{itemize}
\item З 2019 року автор офіційно повідомив про обмежену підтримку та запросив нових мейнтейнерів.
...
Для верифікації теоретичних висновків було проведено практичну міграцію у репозиторії \texttt{ehealth-ua/esoz}. Оригінальний файл \texttt{apiary.apib} (1 061 617 байт) було адаптовано до вимог Blueprinter та збережено як \texttt{esoz-blueprint.apib} (1 007 359 байт). Серед виконаних коригувань:
\begin{enumerate}
...
Практична апробація підтвердила архітектурну правильність вибору: репозиторій \texttt{ehealth-ua/esoz} з мігрованим файлом \texttt{esoz-blueprint.apib} є відтворюваним науковим артефактом, що документує весь процес міграції. Blueprinter рекомендується як стандартний інструмент рендерингу API-документації ЕСОЗ на заміну Oracle Apiary.

У будь якому випадку апробація допомогла усунути всі помилки накопичені в ЕСОЗ за 5 років і провести попередню фільтрацію даних MSON
для подальшої менш болісної конвертації в інші формати OpenAPI, не тільки API Blueprint, а також Swagger.

Кількість часу потрачена на дистилювання MSON датасету ЕСОЗ співставна з часом небхідним на розробку нового продукту спеціально під вимоги ЕСОЗ,
або як варіант — замороження blueprinter і переписування його на мову, яка менш часто видозмінюється, потребує меншої підтримки і мінімізує
ризики, тобто rewrite з Node.js на Ruby чи Elixir, який вже використовується в ЕСОЗ. Це дасть змогу мінімізувати підтримку і час, що пов'язані з постачальниками
напівфабрикатів необхідних для функціонування ЕСОЗ.
