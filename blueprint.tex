...
ризики, тобто rewrite з Node.js на Ruby чи Elixir, який вже використовується в ЕСОЗ. Це дасть змогу мінімізувати ризики пов'язані з постачальниками
напівфабрикатів необхідних для підтримки ЕСОЗ.
